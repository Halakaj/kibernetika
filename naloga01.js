...
io.sockets.on("connection", function(socket) {
    socket.on("ukazArduinu", function(štUkaza) {
        ...
        if (štUkaza == "2") {
            board.digitalWrite(12); // zapišemo 0V na pin8
        }
        if (štUkaza == "5") {
            board.digitalWrite(11, board.HIGH); // zapišemo +5V na pin 13
        }
        if (štUkaza == "4") {
            board.digitalWrite(11, board.LOW); // zapišemo 0V na pin13
        }
        if (štUkaza == "7") {
            board.digitalWrite(10); // zapišemo +5V na pin 8
        }
        if (štUkaza == "6") {
            board.digitalWrite(10); // zapišemo 0V na pin8
        }
        if (štUkaza == "9") {
            board.digitalWrite(13, board.HIGH); // zapišemo +5V na pin 13
        }
        if (štUkaza == "8") {
            ...
            board.digitalWrite(12, board.HIGH); // zapišemo +5V na pin 13
        }
        if (štUkaza == "8") {
        ...
        if (štUkaza == "8") {
            ...
            board.digitalWrite(10, board.HIGH); // zapišemo +5V na pin 13
        }
        if (štUkaza == "8") {
            board.digitalWrite(10, board.LOW); // zapišemo 0V na pin13
        }
