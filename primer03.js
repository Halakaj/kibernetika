...
var board = new firmata.Board("/dev/ttyACM0", function(){// ACM (Abstract Control Model)
    ...
    board.pinMode(8, board.MODES.OUTPUT); // Posamezni pin konfiguriramo, da deluje kot vhod ali izhod                                                    // za serijsko komunikacijo z Arduinom (lahko je USB)
...
http.createServer(function(req, res){ // http.createServer([requestListener])
    ...
    res.write("Za test vpišite v brskalnikovo vrstico z naslovom: http://192.168.1.101:8080/1/1 <br>");
    res.write("ali: http://192.168.1.101:8080/0/0<br>");
